      ...
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-sm overflow-hidden border border-gray-100">
        <div className="p-8 space-y-8">
          <div className="text-center">
            <h2 className="text-2xl font-bold text-gray-900">Welcome to VotePath</h2>
            <p className="text-sm text-gray-500 mt-2">Sign in to sync your personalized roadmap.</p>
          </div>
