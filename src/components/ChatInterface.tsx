    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end" onKeyDown={handleKeyDown}>
      <AnimatePresence>
        {isOpen && (
          ...
          >
            {/* Header */}
            <div className="bg-election-blue-600 text-white p-4 pb-2 flex justify-between items-start shrink-0">
              ...
              <button 
                ...
                className="text-white/80 hover:text-white focus:outline-none focus:ring-2 focus:ring-white rounded p-1"
